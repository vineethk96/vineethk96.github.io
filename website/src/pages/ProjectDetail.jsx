      ...
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div variants={fadeUp} custom={3} className="technic-module p-6 mb-10">
          ...
          {project.detailed_description ? (
            <div
              className="prose prose-sm max-w-none text-primary-sub prose-headings:font-heading prose-headings:text-primary prose-strong:text-primary prose-a:text-primary dark:prose-invert prose-img:mx-auto prose-img:block prose-figure:mx-auto prose-blockquote:[color:var(--tw-prose-body)]"
